...
public final class ExpressionMath
{
    ...
    public static boolean gt(Object left, Object right)
    {
        ...
        {
            byte a = ((Boolean) left).booleanValue() ? ONE
                    : ZERO;
            byte b = ((Boolean) right).booleanValue() ? ONE
                    : ZERO;
            return a - b > 0;
        }
    ...
    public static boolean eq(Object left, Object right, boolean throwIfNotComparable)
    {
                ...
                || !(left instanceof Comparable))
        {
            ...
            {
                throw new IllegalArgumentException(String.format("Cannot compare %s (%s) and %s (%s)", left, left.getClass()
                        .getSimpleName(), right,
                        right.getClass()
                                .getSimpleName()));
            }
    ...
    private static Number convertToNumber(Number number, Object other, boolean throwIfNotConvertible)
    {
        ...
        catch (NumberFormatException e)
        {
            ...
            {
                throw new IllegalArgumentException("Cannot convert value " + other
                                                   + " to datatype "
                                                   + number.getClass()
                                                           .getSimpleName());
            }
