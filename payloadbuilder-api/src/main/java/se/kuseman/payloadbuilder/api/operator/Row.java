...
public class Row implements Tuple
{
    ...
    public Tuple getTuple(int ordinal)
    {
         ...
         * ie
         *
         * select x.col1, <- target ordinal 0 x.col2 <- target ordinal 0 from <- ordinal 0 ( from table <- ordinal 1 ) x
         *
         */
    ...
    {
        return columns != null ? columns.length
    ...
    public int getColumnOrdinal(String column)
    {
        ...
        Column col = tableAlias.getTableMeta()
                .getColumn(column);
        return col != null ? col.getOrdinal()
                : -1;
    }
