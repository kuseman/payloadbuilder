...
// CSON
{
     ...
     */
    public Schema getSchema(IExecutionContext context, List<IExpression> arguments, List<Option> options)
    {
     ...
     */
    public Map<String, Object> getDescribeProperties(IExecutionContext context, List<IExpression> arguments, FunctionData functionData)
    {
        return emptyMap();
    }
