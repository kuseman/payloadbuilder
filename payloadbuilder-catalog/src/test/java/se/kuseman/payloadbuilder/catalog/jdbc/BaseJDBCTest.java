    ...
    public void before()
    {
        ...
        try (Connection con = datasource.getConnection())
        {
            ...
            List<List<String>> columnValues = List.of(
                    List.of("1", "'one'",   "10", getBooleanValue(false), "10.10", "100.100", "1000.1111", "'2010-07-10 10:10:10'"),
                    List.of("2", "'two'",   "20", getBooleanValue(true),  "20.22", "200.222", "2000.2222", "'2011-08-11 11:11:11'"),
                    List.of("3", "'three'", "30", getBooleanValue(false), "30.33", "300.333", "3000.3333", "'2012-09-12 12:12:12'"),
                    List.of("4", "'four'",  "40", getBooleanValue(true),  "40.44", "400.444", "4000.4444", "'2013-10-13 13:13:13'"),
                    List.of("5", "'five'",  "50", getBooleanValue(false), "50.55", "500.555", "5000.5555", "'2014-11-14 14:14:14'")
                    );
