...
public class NullPredicateExpression extends Expression
{
    ...
    public Expression fold()
    {
        if (expression instanceof LiteralExpression)
        {
            ...
            return nullValue ? LiteralBooleanExpression.TRUE_LITERAL
    ...
    public ExpressionCode generateCode(CodeGeneratorContext context)
    {
         ...
         *
         * boolean n_1 = false; boolean v_1 = (!)n_0;
         *
         */
        ...
        code.setCode(String.format(template, toString(), childCode.getCode(), code.getNullVar(), code.getResVar(), not ? "!"
