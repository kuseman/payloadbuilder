    ...
    private static class AstBuilder extends PayloadBuilderQueryParserBaseVisitor<Object>
    {
        ...
        public Object visitTableSource(TableSourceContext ctx)
        {
            ...
            if (ctx.tableName() != null)
            {
                ...
                TableSourceReference tableSourceRef = new TableSourceReference(tableSourceCount++, catalogAlias, getQualifiedName(ctx.tableName()
                        .qname()), alias);
            ...
            else if (ctx.variable() != null)
            {
                ...
                TableSourceReference tableSource = new TableSourceReference(tableSourceCount++, "", qname, alias);
            ...
            else if (ctx.expression() != null)
            {
                ...
                IExpression expression = getExpression(ctx.expression());
                TableSourceReference tableSource = new TableSourceReference(tableSourceCount++, "", QualifiedName.of(expression.toString()), alias);
            ...
            TableSourceReference tableSourceRef = new TableSourceReference(tableSourceCount++, catalogAlias, QualifiedName.of(functioName), alias);
