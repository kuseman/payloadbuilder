        ...
        public Object visitTableSource(TableSourceContext ctx)
        {
            ...
            else if (ctx.derivedTable() != null)
            {
                        ...
                        .selectStatement() != null)
                {
                    ...
                    {
                        throw new ParseException("Columns alias not supported on sub queries statements", columnAliasList);
                    }
                        ...
                        .expression() != null)
                {
                    ...
                    if (columnAliasList != null)
                    {
                        throw new ParseException("Columns alias not supported on expression expression selects", columnAliasList);
                    }
