...
public class ConstantScan implements ILogicalPlan
{
    ...
    /** Constructs a constant scan be provided column names and row expresions. */
    ...
    /** Constructs a constant scan be provided column names and a single row of expresions. */
