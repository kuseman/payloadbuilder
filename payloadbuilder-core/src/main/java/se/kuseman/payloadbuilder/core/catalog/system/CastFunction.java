...
class CastFunction extends ScalarFunctionInfo
{
    ...
    public List<? extends IExpression> foldArguments(List<? extends IExpression> arguments)
    {
        ...
        if (arguments.get(1) instanceof UnresolvedQualifiedReferenceExpression)
        {
            ...
            DataType dataType = EnumUtils.getEnumIgnoreCase(DataType.class, qre.getQname()
                    .toDotDelimited()
                    .toUpperCase());
            if (dataType != null)
            {
                List<IExpression> result = new ArrayList<>(arguments);
                result.set(1, new LiteralStringExpression(dataType.name()));
                return result;
            }
        }
    ...
    public Object eval(IExecutionContext context, String catalogAlias, List<? extends IExpression> arguments)
    {
        ...
        if (arguments.size() >= 3)
        {
            Object styleObject = arguments.get(2)
                    .eval(context);
    ...
    enum DataType
    {
        ...
        DATETIME(LocalDateTime.class)
        {
            ...
            Object convert(Object source, int style)
            {
                ...
                {
                    return ((ZonedDateTime) source).withZoneSameInstant(ZoneId.systemDefault())
                            .toLocalDateTime();
                }
