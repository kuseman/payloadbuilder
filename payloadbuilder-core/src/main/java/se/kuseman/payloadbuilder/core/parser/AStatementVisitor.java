...
public class AStatementVisitor<TR, TC> implements StatementVisitor<TR, TC>, SelectVisitor<TR, TC>
{
    ...
    public TR visit(IfStatement statement, TC context)
    {
        ...
        return visitChildren(context, statement.getStatements(), statement.getElseStatements()
                .toArray(EMPTY));
    }
    ...
    public TR visit(Select select, TC context)
    {
        ...
        select.getComputedExpressions()
                .forEach(e -> visitExpression(context, e));
        ...
        select.getGroupBy()
                .forEach(g -> visitExpression(context, g));
        select.getOrderBy()
                .forEach(o -> o.accept(this, context));
        return null;
    }
    ...
    {
        joinedTableSource.getTableSource()
                .accept(this, context);
        joinedTableSource.getJoins()
                .forEach(j -> j.accept(this, context));
        return null;
    }
    ...
    {
        table.getOptions()
                .forEach(to -> visitExpression(context, to.getValueExpression()));
        return null;
    }
    ...
    {
        tableFunction.getArguments()
                .forEach(a -> visitExpression(context, a));
    ...
    {
        tableSource.getSelect()
                .accept(this, context);
        tableSource.getOptions()
                .forEach(to -> visitExpression(context, to.getValueExpression()));
        return null;
    }
