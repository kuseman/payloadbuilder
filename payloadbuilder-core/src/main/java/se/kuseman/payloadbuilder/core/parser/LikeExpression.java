...
/** Like expression */
public class LikeExpression extends Expression implements ILikeExpression
{
    ...
    public boolean isConstant()
    {
        return expression.isConstant()
                ...
                && (escapeCharacterExpression == null
                        || escapeCharacterExpression.isConstant());
    }
    ...
    public Object eval(IExecutionContext context)
    {
        ...
        boolean matches = pattern.matcher(matchValue)
                .find();
        return not ? !matches
                : matches;
    }
