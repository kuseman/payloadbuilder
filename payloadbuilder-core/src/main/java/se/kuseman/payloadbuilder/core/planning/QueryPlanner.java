...
class QueryPlanner implements ILogicalPlanVisitor<IPhysicalPlan, StatementPlanner.Context>
{
    ...
    public IPhysicalPlan visit(Projection plan, Context context)
    {
        ...
        return wrapWithAnalyze(context, new se.kuseman.payloadbuilder.core.physicalplan.Projection(context.getNextNodeId(), input, expressions, plan.isAppendInputColumns()));
    }
