...
public class Select extends ASelectNode
{
    ...
    public Select(List<SelectItem> selectItems, TableSourceJoined from, Table into, Expression topExpression, Expression where, List<Expression> groupBy, List<SortItem> orderBy, For forOutput,
