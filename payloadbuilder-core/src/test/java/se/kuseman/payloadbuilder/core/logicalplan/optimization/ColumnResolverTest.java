...
// CSON
{
    ...
    public void test_precedence_of_current_outer_matches_asterisk_and_not_asterisk()
    {
        ...
        Schema objectArraySchema = Schema.of(
            col("col2", ResolvedType.of(Type.Any), e_b.withSource(tableB)),
            col("col3", ResolvedType.array(Type.Any), tableC),
            col("col4", ResolvedType.of(Type.Any), e_b.withSource(tableB)),
                ...
                projection(
                    new Join(
                        ...
                        new OperatorFunctionScan(
                                ...
                                projection(
                                    new ExpressionScan(
                                        e_b.withSource(tableB),
                                        Schema.of(ast("b", ResolvedType.of(Type.Any), e_b.withSource(tableB))),
                                        ocre("b", tableB, ResolvedType.table(schemaB), CoreColumn.Type.POPULATED),
                                        null),
                                    asList(
                                        cre("col2", e_b.withSource(tableB), tableB),
                                        ...
                                        cre("col4", e_b.withSource(tableB), tableB),
                                        ocre("col3", tableA),
    ...
    public void test_populate_join_expression_scan_schema_less()
    {
        ...
        Schema subQuerySchema = Schema.of(col("col", ResolvedType.ANY, e_b.withSource(tableB)), col("col2", ResolvedType.ANY, e_b.withSource(tableB)), col("col3", ResolvedType.ANY, tableA));
                ...
                new Join(
                    ...
                    new OperatorFunctionScan(
                        ...
                        projection(
                            new ExpressionScan(
                                e_b.withSource(tableB),
                                Schema.of(ast("b", ResolvedType.ANY, e_b.withSource(tableB))),
                                ocre("b", tableB, ResolvedType.table(schemaB), CoreColumn.Type.POPULATED),
                                null),
                            List.of(
                                cre("col", e_b.withSource(tableB), tableB),
                                cre("col2", e_b.withSource(tableB), tableB),
                                ocre("col3", tableA))
                        ),
                        "",
    ...
    public void test_populate_join_with_expression_scan_schema_full()
    {
        ...
        //@formatter:off
        Schema objectArraySchema = Schema.of(
            col("col3", ResolvedType.of(Type.Float), e_b.withSource(sTableB)),
            col("col2", ResolvedType.of(Type.String), e_b.withSource(sTableB)),
                ...
                projection(
                    new Join(
                        ...
                        new OperatorFunctionScan(
                            ...
                            projection(
                                new ExpressionScan(
                                    e_b.withSource(sTableB),
                                    Schema.of(
                                        col("col1", ResolvedType.of(Type.Boolean), e_b.withSource(sTableB)),
                                        col("col2", ResolvedType.of(Type.String), e_b.withSource(sTableB)),
                                        col("col3", ResolvedType.of(Type.Float), e_b.withSource(sTableB))),
                                    ocre("b", sTableB, 3, ResolvedType.table(schemaSTableB), CoreColumn.Type.POPULATED),
                                    null),
                                asList(
                                    cre("col3", e_b.withSource(sTableB), sTableB, 2, ResolvedType.of(Type.Float)),
                                    cre("col2", e_b.withSource(sTableB), sTableB, 1, ResolvedType.of(Type.String)),
