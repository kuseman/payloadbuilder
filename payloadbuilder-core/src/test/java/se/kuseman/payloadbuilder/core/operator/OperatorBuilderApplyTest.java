...
public class OperatorBuilderApplyTest extends AOperatorTest
{
    ...
    public void test_cross_apply()
    {
        ...
        Operator expected = new NestedLoopJoin(3, "", result.tableOperators.get(0), new CachingOperator(2, result.tableOperators.get(1)), null, new DefaultTupleMerger(-1, 1, 2), false, false);
    ...
    public void test_cross_apply_with_populate()
    {
        ...
        Operator expected = new NestedLoopJoin(3, "", result.tableOperators.get(0), new CachingOperator(2, result.tableOperators.get(1)), null, new DefaultTupleMerger(-1, 1, 2), true, false);
    ...
    public void test_outer_apply()
    {
        ...
        Operator expected = new NestedLoopJoin(3, "", result.tableOperators.get(0), new CachingOperator(2, result.tableOperators.get(1)), null, new DefaultTupleMerger(-1, 1, 2), false, true);
    ...
    public void test_outer_apply_with_pushdown()
    {
        ...
        Operator expected = new NestedLoopJoin(4, "OUTER APPLY", result.tableOperators.get(0),
                new CachingOperator(3, new FilterOperator(2, result.tableOperators.get(1), new ExpressionPredicate(en("a.active_flg = true")))), null, new DefaultTupleMerger(-1, 1, 2), false, true);
    ...
    public void test_outer_apply_not_pushdown_is_null()
    {
        ...
        Operator expected = new FilterOperator(5, new NestedLoopJoin(4, "OUTER APPLY", result.tableOperators.get(0),
                new CachingOperator(3, new FilterOperator(2, result.tableOperators.get(1), new ExpressionPredicate(en("a.active_flg = true")))), null, new DefaultTupleMerger(-1, 1, 2), false, true),
    ...
    public void test_outer_apply_with_populate()
    {
        ...
        Operator expected = new NestedLoopJoin(3, "", result.tableOperators.get(0), new CachingOperator(2, result.tableOperators.get(1)), null, new DefaultTupleMerger(-1, 1, 2), true, true);
