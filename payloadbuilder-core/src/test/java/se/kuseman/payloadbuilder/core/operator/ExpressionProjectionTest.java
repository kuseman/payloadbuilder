...
public class ExpressionProjectionTest extends AParserTest
{
    ...
    {
        QualifiedReferenceExpression qre = new QualifiedReferenceExpression(QualifiedName.of("col"), -1, new ResolvePath[] { new ResolvePath(-1, -1, asList("col"), -1, type) }, null);
    ...
    private OutputWriter generateAndWrite(Projection p, Consumer<Tuple> c)
    {
        ...
        final Projection projection = generator.generateProjection(r);
