...
import se.kuseman.payloadbuilder.core.physicalplan.OverScan;
...
public class QueryPlannerTest extends APhysicalPlanTest
{
    ...
    public void test_outer_apply_non_correlated()
    {
        ...
        queryStatement = StatementPlanner.plan(session, "t", queryStatement);
        ...
        Schema expectedSchemaA = Schema.of(new Column("a", ResolvedType.of(Type.Any), aAst));
        Schema expectedSchemaB = Schema.of(new Column("b", ResolvedType.of(Type.Any), bAst));
        //@formatter:off
        IPhysicalPlan expected = NestedLoop.leftJoin(
                2,
                new TableScan(0, expectedSchemaA, tableA, false, t.scanDataSources.get(0), emptyList()),
                new TableScan(1, expectedSchemaB, tableB, false, t.scanDataSources.get(1), emptyList()),
                null);
        //@formatter:on
    ...
    public void test_outer_apply_correlated()
    {
        ...
        IPhysicalPlan expected = NestedLoop.leftJoin(
                ...
                asSet(Column.of(aAst.rename("id"), ResolvedType.of(Type.Any))),
                null);
        //@formatter:on
    ...
    public void test_cross_join()
    {
        ...
        TestCatalog t = new TestCatalog(emptyMap())
        {
            ...
            {
                if (table.toDotDelimited()
                        .equalsIgnoreCase("tableB"))
                {
                    return new TableSchema(Schema.EMPTY, asList(new Index(table, asList("col"), ColumnsType.ANY_IN_ORDER, 0)));
                }
    ...
    public void test_top_temp_table()
    {
        ...
        IPhysicalPlan expected = new Limit(
                1,
                new TableScan(0, Schema.EMPTY, tableA, true, new IDatasource()
                {
                    @Override
    ...
    public void test_table_function()
    {
        ...
        //@formatter:off
        IPhysicalPlan expected = new TableFunctionScan(0, range, "", SystemCatalog.get().getTableFunction("range"), asList(intLit(1), intLit(100)), emptyList());
        //@formatter:on
    ...
    public void test_order_by_with_catalog_support()
    {
        ...
        //@formatter:off
        IPhysicalPlan expected = new TableScan(0, expectedSchemaA, tableA, false, t.scanDataSources.get(0), emptyList());
        //@formatter:on
                ...
                NestedLoop.innerJoin(
                    ...
                    NestedLoop.leftJoin(
                        ...
                        Assert.maxRowCount(
                            ...
                            new Projection(
                                2,
                                new TableScan(1, expectedSchemaB, tableB, false, t.scanDataSources.get(0), emptyList()),
                                asList(new AliasExpression(cre(bAst.rename("col1")), "__expr0")),
                                false),
                            1),
                        null),
                    new TableScan(5, expectedSchemaA, tableA, false, t.scanDataSources.get(1), emptyList()),
                    null,
                    true),
        ...
        IPhysicalPlan expected = new Projection(
                ...
                NestedLoop.leftJoin(
                    ...
                    new OperatorFunctionScan(
                        ...
                        new Projection(
                            4,
                            new OverScan(3, -1, "b", expectedSchemaB),
                            asList(cre(bAst.rename("col1")), cre(bAst.rename("col2"))),
                            false),
                        SystemCatalog.get().getOperatorFunction("object"),
                        "",
                        Schema.of(Column.of("__expr0", ResolvedType.of(Type.OutputWritable)))),
                    asSet(Column.of(bAst.rename("b"), ResolvedType.tupleVector(expectedSchemaB))),
                    null),
                asList(cre(aAst), cre("b", bAst.rename("b"), "b", ResolvedType.tupleVector(expectedSchemaB)), new AliasExpression(ce("__expr0", ResolvedType.of(Type.OutputWritable)), "values")),
                false);
        //@formatter:on
    ...
    public void test_indexed_join()
    {
        ...
        SeekPredicate expectedSeekPredicate = new SeekPredicate(new Index(QualifiedName.of("tableB"), asList("col"), ColumnsType.ANY_IN_ORDER, 0), asList("col"), asList(cre(aAst.rename("col"))));
        ...
        IPhysicalPlan expected = NestedLoop.leftJoin(
                ...
                new Filter(
                    2,
                    new IndexSeek(1, expectedSchemaB, tableB, expectedSeekPredicate, t.seekDataSources.get(0), emptyList()),
                    new ExpressionPredicate(eq(cre(bAst.rename("active")), LiteralBooleanExpression.TRUE))),
    ...
    public void test_indexed_join_with_sub_query_with_join()
    {
        ...
        TestCatalog t = new TestCatalog(emptyMap())
        {
            ...
            public TableSchema getTableSchema(IQuerySession session, String catalogAlias, QualifiedName table)
            {
                String tbl = table.toDotDelimited();
        ...
        Schema expectedSchemaA = Schema.of(new Column("a", ResolvedType.of(Type.Any), aAst));
        Schema expectedSchemaB = Schema.of(new Column("b", ResolvedType.of(Type.Any), bAst));
        Schema expectedSchemaC = Schema.of(new Column("c", ResolvedType.of(Type.Any), cAst));
        
        SeekPredicate expectedSeekPredicateB = new SeekPredicate(new Index(QualifiedName.of("tableB"), asList("col"), ColumnsType.ANY_IN_ORDER, 0), asList("col"), asList(cre(aAst.rename("col"))));
        SeekPredicate expectedSeekPredicateC = new SeekPredicate(new Index(QualifiedName.of("tableC"), asList("col"), ColumnsType.ANY_IN_ORDER, 0), asList("col"), asList(cre(bAst.rename("col"))));
        ...
        IPhysicalPlan expected = NestedLoop.leftJoin(
                ...
                new HashAggregate(
                    ...
                    NestedLoop.innerJoin(
                       3,
                       new IndexSeek(1, expectedSchemaB, tableB, expectedSeekPredicateB, t.seekDataSources.get(0), emptyList()),
                       new IndexSeek(2, expectedSchemaC, tableC, expectedSeekPredicateC, t.seekDataSources.get(1), emptyList()),
                       new ExpressionPredicate(
                    ...
                    asList(
                        ...
                        new AggregateWrapperExpression(new AliasExpression(
                                new ComparisonExpression(
                                    ...
                                    new FunctionCallExpression("", SystemCatalog.get().getScalarFunction("count"), null, asList(intLit(1))),
                                    intLit(0)),
                                "active"), true, false)
                    )
                    ),
    ...
    public void test_indexed_join_multiple_columns_any_in_order()
    {
        ...
        TestCatalog t = new TestCatalog(emptyMap())
        {
            ...
            public TableSchema getTableSchema(IQuerySession session, String catalogAlias, QualifiedName table)
            {
                if (table.toDotDelimited()
                        .equalsIgnoreCase("tableB"))
                {
                    return new TableSchema(Schema.EMPTY, asList(new Index(table, asList("col", "col2"), ColumnsType.ANY_IN_ORDER, 0)));
                }
                return super.getTableSchema(session, catalogAlias, table);
            }
        };
        ...
        SeekPredicate expectedSeekPredicate = new SeekPredicate(new Index(QualifiedName.of("tableB"), asList("col", "col2"), ColumnsType.ANY_IN_ORDER, 0), asList("col", "col2"),
    ...
    public void test_predicate_pushdown()
    {
        ...
        ScalarFunctionInfo someFunc = new ScalarFunctionInfo(catalog, "someFunc", FunctionInfo.FunctionType.SCALAR)
        {
        };
        catalog.registerFunction(someFunc);
        ...
        //@formatter:off
        Schema expectedSchema = Schema.of(new Column("", ResolvedType.of(Type.Any), ast));
        
        IPhysicalPlan expected = new Filter(
                1,
                new TableScan(0, expectedSchema, table, false, catalog.scanDataSources.get(0), emptyList()),
                new ExpressionPredicate(
                    and(
                        and(
    ...
    public void test_predicate_pushdown_2()
    {
        ...
        Schema expectedSchema = Schema.of(new Column("t", ResolvedType.of(Type.Any), ast));
        IPhysicalPlan expected = new TableScan(0, expectedSchema, table, false, catalog.scanDataSources.get(0), emptyList());
    ...
    {
        return PARSER.parseQuery(session, query);
    }
