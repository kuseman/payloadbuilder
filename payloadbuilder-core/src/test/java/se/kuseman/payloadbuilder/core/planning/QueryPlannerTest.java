    ...
    public void test_sub_query_expression_with_switched_inputs_with_over()
    {
        ...
        IPhysicalPlan expected = new Projection(
                ...
                NestedLoop.leftJoin(
                    ...
                    new OperatorFunctionScan(
                        ...
                        new Projection(
                            ...
                            new ExpressionScan(
                                ...
                                e_b,
                                e_bExpectedSchema,
                                ocre(bAst.populate("b"), ResolvedType.table(expectedSchemaB))),
                    ...
                    asSet(CoreColumn.of(bAst.populate("b"), ResolvedType.table(expectedSchemaB))),
                    null),
                asList(cre(aAst), cre("b", bAst.populate("b"), "b", ResolvedType.table(expectedSchemaB)), new AliasExpression(ce("__expr0", ResolvedType.table(objectArraySchema)), "values")),
                false);
        //@formatter:on
