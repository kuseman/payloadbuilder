...
public class AggregateAvgFunctionTest extends APhysicalPlanTest
{
    ...
    public void test_object()
    {
        ...
        ValueVector four = ValueVector.literalObject(ResolvedType.of(Type.Any), new BigDecimal("100.10"), new BigDecimal("-200.10"), new BigDecimal("2000.10"));
        ...
        assertVectorsEquals(vv(Type.Any, -47.5D, 10_000_000, null, 633.3666666666667D), actual);
    }
    ...
    public void test_long_scalar_value_vector()
    {
        ...
        Schema schema = Schema.of(Column.of("col1", ResolvedType.valueVector(ResolvedType.of(Type.Long))));

        TupleVector input = TupleVector.of(schema, asList(vv(ResolvedType.valueVector(ResolvedType.of(Type.Long)), smallLongs, mediumLongs, nulls)));
