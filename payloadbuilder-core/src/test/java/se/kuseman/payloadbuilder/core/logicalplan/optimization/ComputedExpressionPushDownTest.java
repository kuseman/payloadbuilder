...
public class ComputedExpressionPushDownTest extends ALogicalPlanOptimizerTest
{
    ...
    public void test_sort_on_non_aggregated_column()
    {
        ...
        // fail("Should fail becuase col2 is not aggregatd");
        // }
        // catch (ParseException e)
        // {
        // assertTrue(e.getMessage(), e.getMessage()
        // .contains("col2 is invalid in ORDER BY clause becuase it's not contained in the GROUP BY clause or in an aggregate function"));
        // }
    }
    ...
    public void test_sort_on_aggregate_column_that_is_not_projected_and_verify_pushed_down()
    {
        ...
        // {
        // assertTrue(e.getMessage(), e.getMessage()
        // .contains("col is invalid in ORDER BY clause becuase it's not contained in the GROUP BY clause or in an aggregate function"));
        // }
    }
