...
public class JoinBenchmark extends APhysicalPlanTest
{
    ...
    private static final TableSourceReference TS_OUTER = new TableSourceReference(0, "", QualifiedName.of("outer"), "");
    private static final TableSourceReference TS_INNER = new TableSourceReference(0, "", QualifiedName.of("inner"), "");
