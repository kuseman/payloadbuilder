...
{
    private TableSourceReference tableA = new TableSourceReference(-1, "", QualifiedName.of("tableA"), "a");
    private TableSourceReference tableB = new TableSourceReference(-1, "", QualifiedName.of("tableB"), "b");
    private TableSourceReference tableC = new TableSourceReference(-1, "", QualifiedName.of("tableC"), "c");
