...
public abstract class AJoinTest extends APhysicalPlanTest
{
    ...
    {
        Schema outerSchema = Schema.of(CoreColumn.of(table.column("col1"), ResolvedType.of(Type.Int)), CoreColumn.of(table.column("col2"), ResolvedType.of(Type.Any)));
        Schema innerSchema = Schema.of(CoreColumn.of(tableB.column("col3"), ResolvedType.of(Type.String)), CoreColumn.of(tableB.column("col4"), ResolvedType.of(Type.Any)));
