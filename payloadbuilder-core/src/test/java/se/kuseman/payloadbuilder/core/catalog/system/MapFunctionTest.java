...
import static se.kuseman.payloadbuilder.core.utils.CollectionUtils.asOrderedSet;
...
public class MapFunctionTest extends APhysicalPlanTest
{
    ...
    public void test_nested_mapping()
    {
        ...
        tv = TupleVector.of(Schema.of(new Column("col", ResolvedType.valueVector(ResolvedType.of(Type.Int)))),
                asList(vv(ResolvedType.valueVector(ResolvedType.of(Type.Int)), vv(ResolvedType.of(Type.Int), 1, 2, 3), vv(ResolvedType.of(Type.Int), 4, 5))));
        ...
        assertEquals(ResolvedType.valueVector(ResolvedType.of(Type.Int)), mapFunction.getType(asList(input, lambdaExpression2)));
        assertEquals(2, actual.size());
        assertEquals(ResolvedType.valueVector(ResolvedType.of(Type.Int)), actual.type());
        assertVectorsEquals(vv(ResolvedType.of(Type.Int), 11, 12, 13), (ValueVector) actual.getValue(0));
        assertVectorsEquals(vv(ResolvedType.of(Type.Int), 14, 15), (ValueVector) actual.getValue(1));
    }
    ...
    public void test_mapping_populated_column()
    {
        ...
        lambdaExpression = new LambdaExpression(asList("x"), lce("x", 0, ResolvedType.of(Type.String), 1), new int[] { 0 });
        actual = mapFunction.evalScalar(context, tv, "", asList(input, lambdaExpression));

        assertEquals(ResolvedType.valueVector(ResolvedType.of(Type.String)), mapFunction.getType(asList(input, lambdaExpression)));
        assertEquals(3, actual.size());

        //@formatter:off
        assertVectorsEquals(nvv(ResolvedType.valueVector(ResolvedType.of(Type.String)),
    ...
    public void test_iterable_input()
    {
        ...
        assertEquals(ResolvedType.valueVector(ResolvedType.of(Type.Int)), mapFunction.getType(asList(input, lambdaExpression)));
        assertEquals(2, actual.size());
        assertEquals(ResolvedType.valueVector(ResolvedType.of(Type.Int)), actual.type());
        assertVectorsEquals(nvv(ResolvedType.of(Type.Int), 11, 12, 13), (ValueVector) actual.getValue(0));
        assertVectorsEquals(nvv(ResolvedType.of(Type.Int), 14, null, 16), (ValueVector) actual.getValue(1));

        // Collection (set)
        tv = TupleVector.of(Schema.of(col("col", Type.Any)), asList(vv(ResolvedType.of(Type.Any), asOrderedSet(1, 2, 3, 4, 5, 6, null))));
        input = new FunctionCallExpression("", toListFunction, null, asList(ce("col", ResolvedType.of(Type.Any), 0)));
        lambdaExpression = new LambdaExpression(asList("x"), add(lce("x", 0, ResolvedType.of(Type.Any)), intLit(10)), new int[] { 0 });
        actual = mapFunction.evalScalar(context, tv, "", asList(input, lambdaExpression));
        ...
        assertEquals(ResolvedType.valueVector(ResolvedType.of(Type.Int)), actual.type());
        assertVectorsEquals(nvv(ResolvedType.of(Type.Int), 11, 12, 13, 14, 15, 16, null), (ValueVector) actual.getValue(0));
        ...
        assertEquals(1, actual.size());
        assertEquals(ResolvedType.valueVector(ResolvedType.of(Type.Int)), actual.type());
        assertVectorsEquals(nvv(ResolvedType.of(Type.Int), 11, 12, 13, 14, 15, 16), (ValueVector) actual.getValue(0));
        ...
        assertEquals(ResolvedType.valueVector(ResolvedType.of(Type.String)), mapFunction.getType(asList(input, lambdaExpression)));
        assertEquals(3, actual.size());
        assertEquals(ResolvedType.valueVector(ResolvedType.of(Type.String)), actual.type());
        assertVectorsEquals(nvv(ResolvedType.of(Type.String), "110", "210", "310", "410", "510", "610"), (ValueVector) actual.getValue(0));
        assertVectorsEquals(nvv(ResolvedType.of(Type.String), "hello10"), (ValueVector) actual.getValue(1));
        assertVectorsEquals(nvv(ResolvedType.of(Type.String), "10.1110", "20.2210"), (ValueVector) actual.getValue(2));

        // ValueVector
        tv = TupleVector.of(Schema.of(Column.of("col", ResolvedType.valueVector(ResolvedType.of(Type.Int)))),
        ...
        assertEquals(1, actual.size());
        assertEquals(ResolvedType.valueVector(ResolvedType.of(Type.Int)), actual.type());
        assertVectorsEquals(vv(ResolvedType.of(Type.Int), 11, 12, 13, 14, 15, 16), (ValueVector) actual.getValue(0));
        ...
        input = ce("col", ResolvedType.tupleVector(innerSchema), 0);
        lambdaExpression = new LambdaExpression(asList("x"), new FunctionCallExpression("", concatFunction, null, asList(lce("x", 0, ResolvedType.of(Type.String), 1), intLit(10))), new int[] { 0 });
        actual = mapFunction.evalScalar(context, tv, "", asList(input, lambdaExpression));

        assertEquals(ResolvedType.valueVector(ResolvedType.of(Type.String)), mapFunction.getType(asList(input, lambdaExpression)));
        assertEquals(3, actual.size());
        assertEquals(ResolvedType.valueVector(ResolvedType.of(Type.String)), actual.type());
        assertVectorsEquals(nvv(ResolvedType.of(Type.String), "one10", "two10", "three10"), (ValueVector) actual.getValue(0));
        assertVectorsEquals(nvv(ResolvedType.of(Type.String), "four10", "five10", "six10"), (ValueVector) actual.getValue(1));
        assertVectorsEquals(nvv(ResolvedType.of(Type.String), "seven10", "eight10", "nine10"), (ValueVector) actual.getValue(2));
        ...
        //@formatter:off
        tv = TupleVector.of(Schema.of(new Column("col", ResolvedType.tupleVector(innerSchema)), col("key", Type.Int)), asList(
                vv(ResolvedType.tupleVector(innerSchema), 
                        TupleVector.of(innerSchema, asList(vv(ResolvedType.of(Type.Int), 1, 2, 3), vv(ResolvedType.of(Type.String), "one", "two", "three"))),
                        TupleVector.of(innerSchema, asList(vv(ResolvedType.of(Type.Int), 4, 5, 6), vv(ResolvedType.of(Type.String), "four", "five", "six"))),
                        TupleVector.of(innerSchema, asList(vv(ResolvedType.of(Type.Int), 7, 8, 9), vv(ResolvedType.of(Type.String), "seven", "eight", "nine")))),
        ...
        lambdaExpression = new LambdaExpression(asList("x"), new FunctionCallExpression("", concatFunction, null, asList(lce("x", 0, ResolvedType.of(Type.String), 1), ce("key"))), new int[] { 0 });
        actual = mapFunction.evalScalar(context, tv, "", asList(input, lambdaExpression));
        ...
        assertEquals(ResolvedType.valueVector(ResolvedType.of(Type.String)), actual.type());
        assertVectorsEquals(nvv(ResolvedType.of(Type.String), "one10", "two10", "three10"), (ValueVector) actual.getValue(0));
        assertVectorsEquals(nvv(ResolvedType.of(Type.String), "four20", "five20", "six20"), (ValueVector) actual.getValue(1));
        assertVectorsEquals(nvv(ResolvedType.of(Type.String), "seven30", "eight30", "nine30"), (ValueVector) actual.getValue(2));
    }
    ...
    public void test_non_iterable_input()
    {
        ...
        assertVectorsEquals(nvv(ResolvedType.of(Type.Int), 11, 12, 13, null), actual);
        ...
        assertVectorsEquals(nvv(ResolvedType.of(Type.String), "hellohello", "worldhello", "hello"), actual);
        ...
        assertVectorsEquals(nvv(ResolvedType.of(Type.String), "value10", "value210", "10"), actual);
    }
}
