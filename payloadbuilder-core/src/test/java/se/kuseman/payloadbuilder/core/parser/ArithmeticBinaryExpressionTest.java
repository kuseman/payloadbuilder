...
public class ArithmeticBinaryExpressionTest extends AParserTest
{
    ...
    {
        ArithmeticBinaryExpression e = new ArithmeticBinaryExpression(Type.ADD, LiteralExpression.create(null), LiteralExpression.create(10));

        assertEquals(DataType.ANY, e.getDataType());

        e = new ArithmeticBinaryExpression(Type.ADD, LiteralExpression.create(10), LiteralExpression.create(null));

        assertEquals(DataType.ANY, e.getDataType());

        e = new ArithmeticBinaryExpression(Type.ADD, LiteralExpression.create(10), LiteralExpression.create(10));

        assertEquals(DataType.INT, e.getDataType());

        e = new ArithmeticBinaryExpression(Type.ADD, LiteralExpression.create(10), LiteralExpression.create(10L));

        assertEquals(DataType.LONG, e.getDataType());

        e = new ArithmeticBinaryExpression(Type.ADD, LiteralExpression.create(10), LiteralExpression.create(10F));

        assertEquals(DataType.FLOAT, e.getDataType());

        e = new ArithmeticBinaryExpression(Type.ADD, LiteralExpression.create(10), LiteralExpression.create(10D));

        assertEquals(DataType.DOUBLE, e.getDataType());

        QualifiedReferenceExpression qre = new QualifiedReferenceExpression(QualifiedName.of("col"), -1, new ResolvePath[] { new ResolvePath(-1, 0, asList("col"), -1, DataType.FLOAT) }, null);
        e = new ArithmeticBinaryExpression(Type.ADD, qre, LiteralExpression.create(10));
