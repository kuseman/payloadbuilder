...
import se.kuseman.payloadbuilder.core.operator.PredicateAnalyzer.AnalyzeItem;
...
public class PredicateAnalyzerTest extends Assert
{
    ...
    public void test_AnalyzeResult()
    {
        TableAlias root = TableAliasBuilder.of(-1, TableAlias.Type.TABLE, QualifiedName.of("ROOT"), "ROOT")
                .children(asList(TableAliasBuilder.of(0, TableAlias.Type.TABLE, QualifiedName.of("tableA"), "a"), TableAliasBuilder.of(1, TableAlias.Type.TABLE, QualifiedName.of("tableS"), "s")))
                .build();

        TableAlias alias = root.getChildAliases()
                .get(0);

        // CSOFF
        Pair<List<IAnalyzePair>, AnalyzeResult> pair;
        // CSON
        ...
        assertEquals(result(pair(Type.COMPARISION, IComparisonExpression.Type.EQUAL, e("a.flag"), asSet("a"), of("flag"), e("true"), emptySet(), null)), result);
        assertEquals(e("(a.flag = true)"), result.getPredicate());
        pair = result.extractPushdownPairs("a");
        assertEquals(asList(pair(Type.COMPARISION, IComparisonExpression.Type.EQUAL, e("a.flag"), asSet("a"), of("flag"), e("true"), emptySet(), null)), pair.getLeft());
        assertEquals(AnalyzeResult.EMPTY, pair.getValue());

        result = PredicateAnalyzer.analyze(e("a.art_id = s.art_id"), alias);
        assertEquals(result(pair(Type.COMPARISION, IComparisonExpression.Type.EQUAL, e("a.art_id"), asSet("a"), of("art_id"), e("s.art_id"), asSet("s"), of("art_id"))), result);
        ...
        assertEquals(result(pair(Type.NULL, null, e("a.art_id"), asSet("a"), of("art_id"), e("a.art_id is null"), asSet(), null)), result);
        assertEquals(e("a.art_id is null"), result.getPredicate());
        pair = result.extractPushdownPairs("a");
        assertEquals(asList(pair(Type.NULL, null, e("a.art_id"), asSet("a"), of("art_id"), e("a.art_id is null"), asSet(), null)), pair.getLeft());
        assertEquals(AnalyzeResult.EMPTY, pair.getValue());
        ...
        assertEquals(result(pair(Type.NOT_NULL, null, e("a.art_id"), asSet("a"), of("art_id"), e("a.art_id is not null"), asSet(), null)), result);
        assertEquals(e("a.art_id is not null"), result.getPredicate());
        pair = result.extractPushdownPairs("a");
        assertEquals(asList(pair(Type.NOT_NULL, null, e("a.art_id"), asSet("a"), of("art_id"), e("a.art_id is not null"), asSet(), null)), pair.getLeft());
        assertEquals(AnalyzeResult.EMPTY, pair.getValue());
        pair = result.extractPushdownPairs("a", false);
        assertEquals(asList(pair(Type.NOT_NULL, null, e("a.art_id"), asSet("a"), of("art_id"), e("a.art_id is not null"), asSet(), null)), pair.getLeft());
        assertEquals(AnalyzeResult.EMPTY, pair.getValue());
        ...
        assertEquals(result(pair(Type.COMPARISION, IComparisonExpression.Type.GREATER_THAN, e("a.value"), asSet("a"), of("value"), e("100"), asSet(), null),
                pair(Type.COMPARISION, IComparisonExpression.Type.EQUAL, e("a.internet_flg"), asSet("a"), of("internet_flg"), e("false"), asSet(), null),
                pair(Type.COMPARISION, IComparisonExpression.Type.EQUAL, e("active_flg"), asSet(""), of("active_flg"), e("true"), asSet(), null),
                pair(Type.COMPARISION, IComparisonExpression.Type.EQUAL, e("sku_id"), asSet(""), of("sku_id"), e("s.sku_id"), asSet("s"), of("sku_id")),
                pair(Type.COMPARISION, IComparisonExpression.Type.EQUAL, e("a.art_id"), asSet("a"), of("art_id"), e("s.art_id"), asSet("s"), of("art_id"))), result);
        assertEquals(asList(pair(Type.COMPARISION, IComparisonExpression.Type.EQUAL, e("a.internet_flg"), asSet("a"), of("internet_flg"), e("false"), asSet(), null),
                pair(Type.COMPARISION, IComparisonExpression.Type.EQUAL, e("active_flg"), asSet(""), of("active_flg"), e("true"), asSet(), null),
                pair(Type.COMPARISION, IComparisonExpression.Type.EQUAL, e("sku_id"), asSet(""), of("sku_id"), e("s.sku_id"), asSet("s"), of("sku_id")),
                pair(Type.COMPARISION, IComparisonExpression.Type.EQUAL, e("a.art_id"), asSet("a"), of("art_id"), e("s.art_id"), asSet("s"), of("art_id"))), result.getEquiPairs("a"));
        ...
        pair = result.extractPushdownPairs("a");
        assertEquals(asList(pair(Type.COMPARISION, IComparisonExpression.Type.GREATER_THAN, e("a.value"), asSet("a"), of("value"), e("100"), asSet(), null),
                pair(Type.COMPARISION, IComparisonExpression.Type.EQUAL, e("a.internet_flg"), asSet("a"), of("internet_flg"), e("false"), asSet(), null),
                pair(Type.COMPARISION, IComparisonExpression.Type.EQUAL, e("active_flg"), asSet(""), of("active_flg"), e("true"), asSet(), null)), pair.getLeft());
        assertEquals(result(pair(Type.COMPARISION, IComparisonExpression.Type.EQUAL, e("sku_id"), asSet(""), of("sku_id"), e("s.sku_id"), asSet("s"), of("sku_id")),
                pair(Type.COMPARISION, IComparisonExpression.Type.EQUAL, e("a.art_id"), asSet("a"), of("art_id"), e("s.art_id"), asSet("s"), of("art_id"))), pair.getValue());
        assertEquals(e("a.art_id = s.art_id and sku_id = s.sku_id"), pair.getValue()
                .getPredicate());
        ...
        assertEquals(result(pair(Type.UNDEFINED, null, e("a.art_id = s.art_id or (sku_id = s.sku_id and active_flg and not a.internet_flg and a.value > 100)"), asSet("a", "s"), null)), result);
    }
    ...
    public void test_nested_reference()
    {
        TableAlias alias = TableAliasBuilder.of(-1, TableAlias.Type.ROOT, QualifiedName.of("ROOT"), "ROOT")
                .children(asList(TableAliasBuilder.of(0, TableAlias.Type.TABLE, QualifiedName.of("source"), "s"), TableAliasBuilder.of(1, TableAlias.Type.SUBQUERY, QualifiedName.of("source"), "a")
                        .children(asList(TableAliasBuilder.of(-1, TableAlias.Type.ROOT, QualifiedName.of("ROOT"), "ROOT")
                                .children(asList(TableAliasBuilder.of(2, TableAlias.Type.TABLE, QualifiedName.of("article"), "a"),
        ...
        p = PredicateAnalyzer.AnalyzePair.of(alias.getChildAliases()
                .get(0), e("a.ab.active_flg"));
        assertEquals(Type.COMPARISION, p.getType());
        assertEquals(IComparisonExpression.Type.EQUAL, p.getComparisonType());
    ...
    public void test_AnalyzePair()
    {
        TableAlias root = TableAliasBuilder.of(-1, TableAlias.Type.ROOT, QualifiedName.of("ROOT"), "ROOT")
                .children(asList(TableAliasBuilder.of(0, TableAlias.Type.SUBQUERY, QualifiedName.of("SubQuery"), "aa")
                        .children(asList(TableAliasBuilder.of(-1, TableAlias.Type.ROOT, QualifiedName.of("ROOT"), "ROOT")
                                .children(asList(TableAliasBuilder.of(1, TableAlias.Type.TABLE, QualifiedName.of("tableA"), "articleAttribute"),
        ...
        assertEquals(Type.COMPARISION, p.getType());
        assertEquals(IComparisonExpression.Type.GREATER_THAN, p.getComparisonType());
        ...
        root = TableAliasBuilder.of(-1, TableAlias.Type.TABLE, QualifiedName.of("ROOT"), "ROOT")
                .children(asList(TableAliasBuilder.of(0, TableAlias.Type.TABLE, QualifiedName.of("tableS"), "s"), TableAliasBuilder.of(1, TableAlias.Type.SUBQUERY, QualifiedName.of("tableA"), "a")
                        .children(asList(TableAliasBuilder.of(2, TableAlias.Type.TABLE, QualifiedName.of("tableA_A"), "a_a"))),
                        TableAliasBuilder.of(3, TableAlias.Type.TABLE, QualifiedName.of("tableB"), "b"), TableAliasBuilder.of(4, TableAlias.Type.TABLE, QualifiedName.of("tableC"), "c")

                ))
                .build();

        // Start from a_a and traverse up to parent
        alias = root.getChildAliases()
                .get(1)
                .getChildAliases()
                .get(0);
        ...
        catch (IllegalArgumentException e)
        {
            assertTrue(e.getMessage()
                    .contains("No expressions could be found"));
        }
        ...
        assertEquals(Type.COMPARISION, p.getType());
        assertEquals(IComparisonExpression.Type.GREATER_THAN_EQUAL, p.getComparisonType());
    ...
    private AnalyzePair pair(IAnalyzePair.Type type, IComparisonExpression.Type comparisonType, Expression leftExpression, Set<String> leftAliases, QualifiedName leftQname)
    {
        return new AnalyzePair(type, comparisonType, new AnalyzeItem(leftExpression, leftAliases, leftQname), null);
    }

    private AnalyzePair pair(IAnalyzePair.Type type, IComparisonExpression.Type comparisonType, Expression leftExpression, Set<String> leftAliases, QualifiedName leftQname, Expression rightExpression,
            Set<String> rightAliases, QualifiedName rightQname)
    {
        return new AnalyzePair(type, comparisonType, new AnalyzeItem(leftExpression, leftAliases, leftQname), new AnalyzeItem(rightExpression, rightAliases, rightQname));
    }
    ...
    // CSON
    {
        ...
        return StatementResolver.resolve(expr, session);
    }
}
