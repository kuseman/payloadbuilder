...
public class SystemCatalogTest extends AParserTest
{
    ...
    {
        assertTrue(((ScalarFunctionInfo) session.getCatalogRegistry().getSystemCatalog().getFunction("contains")).isCodeGenSupported(asList(e("10"), e("20"))));
    }
    ...
    public void test_function_cast() throws Exception
    {
        ...
        assertExpression(ZonedDateTime.parse("2000-10-10T10:10Z").withZoneSameInstant(ZoneId.systemDefault()).toLocalDateTime(), null, "cast('2000-10-10 10:10Z', 'datetime')");
        assertExpression(ZonedDateTime.parse("2000-10-10T10:10:10.123Z").withZoneSameInstant(ZoneId.systemDefault()).toLocalDateTime(), null, "cast('2000-10-10 10:10:10.123Z', 'datetime')");
