...
public class CsvOutputWriterTest extends Assert
{
    ...
    public void test_delayed_headers()
    {
        ...
        p.getValue().writeFieldName("col4");
        p.getValue().writeValue(2.20f);
        p.getValue().writeFieldName("col5");
        p.getValue().writeValue(true);
        p.getValue().writeFieldName("col6");
        p.getValue().writeValue("some new " + (char) 10 + " sti,ng");
        p.getValue().endObject();
        p.getValue().endRow();
    ...
    public void test()
    {
        ...
        p.getValue().initResult(new String[] {"col1", "col2"});
        p.getValue().startRow();
        p.getValue().writeValue(1);
        ...
        p.getValue().endRow();
        p.getValue().initResult(new String[] {"col3", "col4"});
        p.getValue().startRow();
