    ...
    public void test_batch_cache()
    {
        ...
        Operator expected = new BatchHashJoin(
                ...
                new BatchCacheOperator(
                        2,
                        operators.get(1),
                        new ExpressionOrdinalValuesFactory(asList(en("b.col1"))),
                        new CacheSettings(
                                new ExpressionFunction(en("'tableB'")),
                                new ExpressionFunction(en("@param")),
                                new ExpressionFunction(en("'PT10m'")))),
                new ExpressionOrdinalValuesFactory(asList(en("a.col1"))),
                new ExpressionHashFunction(asList(en("b.col1"))),
                new ExpressionPredicate(en("b.col1 = a.col1")),
        ...
        Operator expected = new BatchHashJoin(
                ...
                new BatchHashJoin(
                        ...
                        new FilterOperator(
                                2,
                                operators.get(1),
                                new ExpressionPredicate(en("a.active_flg = 1"))),
                        new FilterOperator(
                                4,
                                operators.get(2),
                                new ExpressionPredicate(en("aa.active_flg = true"))),
                        new ExpressionOrdinalValuesFactory(asList(en("a.art_id"))),
                        new ExpressionHashFunction(asList(en("aa.art_id"))),
                        new ExpressionPredicate(en("aa.art_id = a.art_id")),
                        new DefaultTupleMerger(-1, 3, 2),
                        false,
                        false,
...
//                System.err.println(expected.toString(1));
    ...
    public void test_inner_join_with_populate_and_filter_and_join_pushdown()
    {
        ...
        Operator expected = new BatchHashJoin(
                ...
                new FilterOperator(
                        2,
                        operators.get(1),
                        new ExpressionPredicate(en("internet_flg = 1 AND a.active_flg = 1"))),
                new ExpressionOrdinalValuesFactory(asList(e("1460"), e("0"), en("s.art_id"))),
                new ExpressionHashFunction(asList(e("1460"), e("0"), en("a.art_id"))),
                new ExpressionPredicate(en("a.art_id = s.art_id")),
                new DefaultTupleMerger(-1, 1, 2),
    ...
    public void test_left_join_with_populate_and_filter_doesnt_pushdown_predicate()
    {
        ...
        Operator expected = new BatchHashJoin(
                ...
                new ExpressionOrdinalValuesFactory(asList(e("1460"), e("0"), en("s.art_id"))),
                new ExpressionHashFunction(asList(e("1460"), e("0"), en("a.art_id"))),
                new ExpressionPredicate(en("a.art_id = s.art_id AND s.flag = true")),
                new DefaultTupleMerger(-1, 1, 2),
                true,
                true,
                c.getIndices(session, "", QualifiedName.of("article")).get(0),
