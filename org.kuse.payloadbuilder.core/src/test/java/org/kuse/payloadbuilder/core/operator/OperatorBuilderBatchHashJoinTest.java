...
public class OperatorBuilderBatchHashJoinTest extends AOperatorTest
{
    ...
    public void test_inner_join_with_cache()
    {
        String queryString = "SELECT a.art_id " +
            "FROM source s " +
            "INNER JOIN article a with (cachename = 'article', cachettl = 'pt10m', cacheouterkey = s.art_id, cacheinnerkey = a.art_id)" +
            "  ON a.art_id = s.art_id " +
            "  AND a.club_id = 1337 + 123 " +
            "  AND a.country_id = 0 " +
            "  AND a.active_flg = 1";
    ...
    @Test
    public void test_inner_join_with_cache_no_filter_cache()
    {
        String queryString = "SELECT a.art_id " +
            "FROM source s " +
            "INNER JOIN article a with (cachename = 'article', cachettl = 'pt10m', cacheouterkey = s.art_id, cacheinnerkey = a.art_id, cachefilters = false)" +
            "  ON a.art_id = s.art_id " +
            "  AND a.club_id = 1337 + 123 " +
            "  AND a.country_id = 0 " +
            "  AND a.active_flg = 1";
        ...
        Operator expected = new BatchHashJoin(
                ...
                new FilterOperator(
                        ...
                        new OuterValuesCacheOperator(
                                2,
                                operators.get(1), //new FilterOperator(2, operators.get(1), new ExpressionPredicate(e("a.active_flg = 1"))),
                                c,
                                "alias",
                                e("'article'"),
                                e("s.art_id"),
                                e("a.art_id"),
                                e("'pt10m'")),
                        new ExpressionPredicate(e("a.active_flg = 1"))),
                new ExpressionValuesExtractor(asList(e("1460"), e("0"), e("s.art_id"))),
                new ExpressionValuesExtractor(asList(e("1460"), e("0"), e("a.art_id"))),
                new ExpressionPredicate(e("a.art_id = s.art_id")),
                DefaultTupleMerger.DEFAULT,
...
//        System.err.println(expected.toString(1));
    ...
    public void test_inner_join_with_populate_and_filter_and_join_pushdown()
    {
        String queryString = "SELECT a.art_id " +
            "FROM source s " +
            "INNER JOIN (from article where internet_flg = 1) a with(populate=true)" +
            "  ON a.art_id = s.art_id " +
            "  AND a.club_id = 1337 + 123 " +
            "  AND a.country_id = 0 " +
            "  AND a.active_flg = 1";
    ...
    public void test_left_join_with_populate_and_filter_doesnt_pushdown_predicate()
    {
        String queryString = "SELECT a.art_id " +
            "FROM source s " +
            "LEFT JOIN (from article where internet_flg = 1) a with (populate=true)" +
            "  ON a.art_id = s.art_id " +
            "  AND a.club_id = 1337 + 123 " +
            "  AND a.country_id = 0 " +
            "  AND a.active_flg = 1" +
